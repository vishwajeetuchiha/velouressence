...
interface SettingDocumentData {
  ...
  /**
   * Nevigation Link field in *Setting*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: setting.nevigation_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  nevigation_link: prismic.Repeatable<
...
export interface VideoSliceDefaultPrimary {
  /**
   * YouTude Video ID field in *Video → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: eTEsWseiDdg
   * - **API ID Path**: video.default.primary.youtude_video_id
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  youtude_video_id: prismic.KeyTextField;
}
