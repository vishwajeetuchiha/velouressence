...
const Video: FC<VideoProps> = ({ slice }) => {
  return (
    <section
      ...
      className="bg-black"
    >
      <h2 className="sr-only">Cote Royal Video Reel</h2>

      <Lazy rootMargin="1500px" className="relative h-screen overflow-hidden md:aspect-video md:h-auto">

       <iframe
          src={`https://www.youtube-nocookie.com/embed/${slice.primary.youtude_video_id}?autoplay=1&mute=1&loop=1&playlist=${slice.primary.youtude_video_id}`}
